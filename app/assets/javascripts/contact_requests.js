$(document).on('turbolinks:load', function() {
  ...
  $('body').on('click', '.accepted-request a', function() {
    ...
    var conversation_window_request_status = $('.conversation-window')
                                                .find('[data-user-name="' +
                                                       receiver_user_name +
                                                       '"]');
    // if a conversation is opened in the messanger
    ...
    requests_menu_item
      .find('.accept-request')
      .replaceWith('<sapn class="accepted-request">Accepted</sapn>');
    requests_menu_item
    ...
    caluculateContactRequests();
    // updae the opposite user with your contact request response
    ApplicationCache.notification.contact_request_response(sender_user_name,
                                                           receiver_user_name,
  ...
  $('body').on('click', '.add-user-to-contacts-notif', function() {
    ...
    var receiver_user_name = $(this)
                                ...
                                .html();
    App.notifcation.contact_request_response(sender_user_name,
                                             receiver_user_name,
...
function calculateContactRequests() {
  ...
  if (unresponded_requests) {
    $('#unresponded-contact-requests').css('visiblity', 'visible');
